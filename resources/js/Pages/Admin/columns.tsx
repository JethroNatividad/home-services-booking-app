...
const ProviderCell = ({ row }: { row: Row<Booking> }) => {
...
const CustomerCell = ({ row }: { row: Row<Booking> }) => {
    const currentUser = row.original.user;
    return (
        <Dialog>
            <DialogTrigger>
                <p className="underline text-blue-500">
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>
                        Customer {currentUser.first_name}{" "}
                        {currentUser.middle_name} {currentUser.last_name}
                    </DialogTitle>
                </DialogHeader>
                <div>
                    <p>
                    ...
                    <p>
                        <strong>Phone:</strong> {currentUser.contact_number}
                    </p>
                    <p>
